...
const NavThemeToggle = () => {
    ...
    return (
        <button
            className={`relative flex w-full items-center gap-6 rounded-[.625rem] px-3 py-2 text-[.9375rem] font-light hover:bg-neutral-200/70 active:bg-neutral-200 dark:hover:bg-neutral-800 dark:active:bg-neutral-700/80`}
        >
            <svg
            ...
            <p>Theme: {theme && theme[0].toUpperCase() + theme.slice(1)}</p>
            <select
                value={theme}
            ...
            <svg
                ...
                strokeLinecap='round'
                strokeLinejoin='round'
                className='pointer-events-none absolute right-2 h-4 w-4 stroke-2'
            >
                <path fill='none' stroke='none' d='M0 0h24v24H0z' />
